...
--	print('FPS:'..love.timer.getFPS(), 20, 0)
--	print('Score:'..game.score, 20, 12)
--	print('Level:'..game.level_name, 20, 24)
--
--	print('Move: left, right, down', g.getWidth() - 300, 0)
--	print('Rotate: up', g.getWidth() - 300, 12)
--	print('Drop: space', g.getWidth() - 300, 24)
--	print('Pause: P', g.getWidth() - 300, 36)
--	print('Restart: R (after "Game over")', g.getWidth() - 300, 48)
--
--	draw_field()
